                         ...
                         max-tiny-phone:w-[15rem] max-tiny-phone:h-fit max-tiny-phone:gap-10`}>
                            <div className="flex flex-col gap-2">
                                <div className="flex flex-row justify-between items-center">
                                    ...
                                    <a id={'link-' + element.id} href={element.gitLink} className="group" target="_blank">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 text-[#e0e1dd] transition-all ease-out duration-300 hover:text-[#778da9] hover:translate-x-1 hover:-translate-y-1">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                                        </svg>
                                    </a>
                                </div>
                                <div id={'textinfo-' + element.id} className="flex flex-col gap-2">
                            ...
                            <div id={'project-skills-' + element.id} className="font-mono content-end text-xs text-[#e0e1dd] flex flex-wrap gap-2 bottom-8">
